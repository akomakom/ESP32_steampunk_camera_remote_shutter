...
#define __NEOPIXEL_MODE_ANTICIPATION_TIMEOUT 10000
#define __NEOPIXEL_MODE_SHIMMER_MIN_BRIGHTNESS 30
#define __NEOPIXEL_MODE_SHIMMER_MAX_BRIGHTNESS 150
#define __NEOPIXEL_MODE_SHIMMER_SPEED 10 // smaller is faster
